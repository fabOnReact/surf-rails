...
$(document).on('turbolinks:load', function () {
  ...
  if (location_path.match(/posts\/[0-9][0-9]/)) {
    Object(__WEBPACK_IMPORTED_MODULE_1__lib_tide__["renderTideChart"])();
  }
...
throw new Error("Module build failed: SyntaxError: 'import' and 'export' may only appear at the top level (7:2)\n\n   5 |   console.warn(forecast)\n   6 |   \n>  7 |   export function renderTideChart() {\n     |   ^\n   8 |     var ctx = document.getElementById('tideChart');\n   9 |     var myChart = new Chart(ctx, {\n  10 |         type: 'bar',\n");

/***/ })
/******/ ]);
//# sourceMappingURL=application-49e533c1a0133c7bbd91.js.map